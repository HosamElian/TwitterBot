...
namespace TwitterBot.DataAccess.Migrations
{
    ...
    [Migration("20240222184454_INITDatabase")]
            ...
            modelBuilder.Entity("TwitterBot.Core.Models.News", b =>
                {
                    ...
                    b.Property<DateTime>("GetNewsTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ParaphrasedById")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime>("ParaphrasingTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TwitterBot.Core.Models.News", b =>
                {
                    ...
                    b.HasOne("TwitterBot.Core.Models.ApplicationUser", "ParaphrasedBy")
                        .WithMany()
                        .HasForeignKey("ParaphrasedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DecisionBy");

                    b.Navigation("ParaphrasedBy");
                });
