        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ParaphrasedById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OriganalNews = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ParaphrasdNews = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NewsSource = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GetNewsTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DecisionTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ParaphrasingTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
